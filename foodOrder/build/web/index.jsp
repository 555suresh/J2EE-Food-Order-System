...
<html>
    ...
    <body data-spy="scroll" data-target=".navbar">
                ...
                <div class="row">
                    ...
                    <div class="span4">
                        ...
                        <div class="thumbnail">
                            ...
                            <img src="themes/images/home/ins2.png" style=" width: 370px;height: 150px;">
                            <a href="#"> More detail</a><p></p>
                        </div>
                        <br>
        ...
        <div id="marquee"style="margin-top:-350px;">
   
            <marquee class="cntr" behavior="scroll" direction="up" scrollamount="5">
                <h1 style="color: #ffffff;"><i style="font-size: 60px"class="icon-double-angle-up"></i></h1>
                <h4>please sign in to Order food</h4>
            </marquee>
