        ...
        <div id="portfolioSection">
            ...
            <div class="container">	
                <ul class="nav nav-pills">
                    ...
                    <li class=""><a href="#comingsoon" data-toggle="tab">Drinks</a></li>
                </ul>
                <div class="clr"></div>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <div class="blockDtl">
                                            ...
                                            <h4>ssssssssssssss 1</h4>
                                            <p> xxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxxxx, </p>
                                          
                                            <button style="margin-bottom: 7px;"   type="submit" class="btn btn-success input-small ">buy </button>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <div class="blockDtl">
                                            ...
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
                                            <button style="margin-bottom: 7px;"   type="submit" class="btn btn-success input-small ">buy </button>
                                            <button style=" margin-bottom: 7px;"  type="reset" class="btn btn-warning" data-toggle="modal" href="#cakeModal">more </button>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <div class="blockDtl">
                                            ...
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, </p>
                                            <button style="margin-bottom: 7px;"   type="submit" class="btn btn-success input-small ">buy </button>
                                            <button style=" margin-bottom: 7px;"  type="reset" class="btn btn-warning" data-toggle="modal" href="#drinksModel">more </button>
                                        </div>
                                    </div>
                                </li>
                                <% } %>
